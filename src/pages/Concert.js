...
const images = [
  {
    id : 1,
    desc : '2020 年是綠盟成立的第20年，以「破浪前行」、感恩音樂會的形式，感謝一路上一直陪伴綠盟前行的夥伴。'
  },
  {
    id : 2,
  ...
  {
    id : 12,
    desc : '綠盟近年來以「透明足跡」作為環境監督的利器，獲得許多夥伴的支持。'
  },
  {
    id : 13,
...
const texts = `
2020是綠盟成立的20週年，走過20個年頭，我們希望能永遠一如草創時期的
活力，朝向下一個世代的環境轉型任務如此艱鉅，未來仍須奮勇破浪前行，我們
都在同一條船上，要靠眾人之力才能稍有寸進。回首20年，一路以來有著許多
熱愛環境及關懷社會的夥伴默默地支持我們的行動，一切點滴在心。`
